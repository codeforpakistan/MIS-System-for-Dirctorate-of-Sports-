              ...
              <div class="row"style="padding:0px;border-radius:40px;box-shadow:10px 10px 100px #00000082">
                ...
                <img src="assets/images/asset_1.png" style="width:100% !important;height:100%; ">
                  ...
                  <div class="col-xl-5" style="background: #fff;border-radius:0px 40px 40px 0px;">
                    <!-- start messages --->
                    <div style="text-align: center;position: absolute;top:20px;left:40px;z-index: 212121212px" class="msg">
                ...
                <form method="POST" action="<?= base_url('Admin/login_user')?>" class="needs-validation" novalidate="">                  
                  <p style="color:#15693F; font-weight: bold;text-align: center;margin-top:90px;font-size:22px;">Login your account</p>
                  <div class="form-group">
                    <div class="d-block">
                    <label for="email" class="control-label"><strong>Useremail</strong></label>
                  </div>
