              ...
              <div class="col-12">
                ...
                <?php endif;?>
                    ...
                    <?php if($this->session->userdata('user_role_id_fk') == '3'):?>
                        ...
                        <tbody>
                          <?php if(!empty($selected_officals)){
                            foreach($selected_officals as $selected_offical){?>
                          
                          <tr>
                          <td><?=ucwords($selected_offical->event_title)?></td>
                          <td><?=ucwords($selected_offical->trial_name)?></td>
                          <td><?=ucwords($selected_offical->game_name)?></td>
                          <td><?=ucwords($selected_offical->name)?></td>
                          <td><?=ucwords($selected_offical->father_name)?></td>
                          <td><?=$selected_offical->cnic?></td>
                          <td><?=$selected_offical->age?></td>
                          <td><?=ucwords($selected_offical->gender)?></td>
                          <td><?=ucwords($selected_offical->physical_status)?></td>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header bg-success">
                <h5 class="modal-title text-white" id="myLargeModalLabel">Add Offical</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  ...
                  <div class="modal-body">
                    <!-- body-->
                        <form class="" method="post" action="<?=base_url("admin/selected_player_offical_insert/offical")?>">
                          <div class="row">
                            <div class="col-6">
     ...
     <!-- Large modal edit -->
        <div class="modal fade bd-example-modal-lg" id="editModel" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header bg-success">
                <h5 class="modal-title text-white" id="myLargeModalLabel">Update Offical</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
                   ...
                   <div class="modal-body">
                    <!-- body-->
                       <form class="" method="post" action="<?=base_url("admin/selected_player_offical_update/offical")?>">
                          <div class="row">
                            <div class="col-6">
                            <div class="form-group">
                                  <label>Event Name</label>
